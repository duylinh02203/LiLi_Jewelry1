<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
    ...
    <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="{{ asset('assets/images/samples/Login_bg.jpg') }}" alt="logo" /></a>
  </div>
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" href="{{route('category')}}">
        ...
        <span class="menu-title">Quản lí danh mục</span>
      </a>
    </li>
    <li class="nav-item menu-items">
      <a class="nav-link" href="{{route('product')}}">
        ...
        <span class="menu-title">Quản lí sản phẩm</span>
      </a>
    </li>
    <li class="nav-item menu-items">
