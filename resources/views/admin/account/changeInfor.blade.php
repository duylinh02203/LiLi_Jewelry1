        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('admin.account.changeInforAccount')}}" class="form-changeUserInfor" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row g-4 mt-md-1 mt-2 wrap-change" style="display:flex ;justify-content: center;align-items: center;">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="email" class="form-control" id="email" style="background-color: #2A3038;"
                            ...
                            <div class="col-md-8" style="display:none">
                                ...
                                <input type="password" name="password" class="form-control" id="first" value="{{ $user->password }}" readonly>
                            </div>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-8" style="display:flex;">
                                <div class="">
                                    <button class="btn btn-solid-default submit-form" type="submit" style="border-radius:10px; background-color:brown; height:40px;">Chỉnh sửa thông tin</button>
                                </div>
                                <div class="">
