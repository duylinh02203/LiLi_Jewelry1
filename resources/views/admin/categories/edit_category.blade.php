            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.category.update', $categoryUpdate->id) }}" class="forms-sample"
                            method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="8">{{ $categoryUpdate->description }}</textarea>
                            </div>
