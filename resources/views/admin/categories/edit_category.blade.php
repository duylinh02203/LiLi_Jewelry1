                ...
                <div class="card-body">
                    ...
                    <form action="{{route('category.update',$category->id)}}" class="forms-sample" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{$category->name}}" name="category_name" type="text" class="form-control" id="exampleInputName1" placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea1">Description</label>
                            <textarea name="category_description" class="form-control" id="exampleTextarea1" rows="8">{{$category->description}}</textarea>
                        </div>
