            ...
            <div class="card">
                <div class="card-body">
                    <div style="text-align: center;">
                        <h4 style="margin-bottom: 5px;">LILI JEWELRY</h4>
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        <div>
                            ...
                            <p><strong>Thu ngân:</strong> Hệ thống</p>
                            <p><strong>Khách hàng:</strong> {{ $order->user->name }}</p>
                            <p><strong>SĐT:</strong> {{ $order->phone }}</p>
                            <p><strong>Địa chỉ:</strong> {{ $order->address }}</p>
                            <p><strong>Phương thức thanh toán :</strong> {{ $order->payment == 'cod' ? 'Thanh toán khi nhận hàng (COD)' : 'Chuyển khoản' }}</p>
                    ...
                    <table style="width: 100%; margin-top: 20px; border-collapse: collapse;">
                        ...
                        <tbody>
                            ...
                            <tr style="text-align: center; font-weight: bold;">
                                ...
                                <td style="border: 1px solid #ccc; padding: 8px;">{{ number_format($order->total_price, 0, ',', '.') }} VNĐ</td>
                            </tr>
                        </tbody>
                    ...
                    <div style="text-align: center; margin-top: 10px;">
                        <a href="{{ url()->previous() }}" style="color: coral; text-decoration: underline;">Quay lại</a>
                    </div>
