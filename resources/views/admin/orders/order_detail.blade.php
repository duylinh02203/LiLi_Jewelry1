...
<div class="content-wrapper">
    <div class="page-header">
        ...
        <div class="link-wrap">
            ...
            <span style="color: #333; cursor: not-allowed;">Đơn hàng</span>
            @else
            <a class="none-a2" href="{{route('admin.order.newOrder')}}">Đơn hàng</a>
            @endif
            <p class="rev">></p>
            @if (request()->routeIs('admin.order.detail'))
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <div>
                            ...
                            <p><strong>In lúc:</strong>
                                {{ $order->created_at->setTimezone('Asia/Ho_Chi_Minh')->format('H:i:s') }}
                            </p>
                        </div>
                    </div>
