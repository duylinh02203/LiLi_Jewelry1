...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">                  
                    <form class="forms-sample" method="POST" action="{{ route('admin.product.create') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <input value="{{ old('name') }}" type="text" class="form-control" name="name" placeholder="Tên sản phẩm">
                        </div>
                        <div class="form-group">
                            <label>Giá tiền
                                @error('price')
                            ...
                            <input value="{{ old('price') }}" type="text" class="form-control" name="price" placeholder="Giá tiền sản phẩm">
                        </div>
                        <div class="form-group">
                            <label>Giá niêm yết
                                @error('listed_price')
                            ...
                            <input value="{{ old('listed_price') }}" type="text" class="form-control" name="listed_price"
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('quantity') }}" type="text" class="form-control" placeholder="Số lượng sản phẩm"
                                name="quantity">
                        </div>
                        <div class="form-group">
