                ...
                <div class="product-box">
                    <div class="img-wrapper">
                        ...
                        <div class="label-block">
                            <span class="price-sale label label-theme">{{ max(0, round((($product->listed_price - $product->price) / $product->listed_price) * 100)) }}% off</span>
                        </div>
                        <div class="cart-wrap">
                            <ul>
                                <li>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            ...
                            <div class="r-price">
                                <div class="theme-color price-color" style="padding-top: 3.5px;">{{ number_format($product->price, 0, ',', '.') }} VNĐ</div>
                            </div>
...
<section class="ratio_asos overflow-hidden pb-5">
    <div class="px-0 container-fluid p-sm-0">
        <div class="row m-0">
            ...
            @php
            $productSales = \App\Models\Product::whereRaw('ROUND((CAST(listed_price AS SIGNED) - CAST(price AS SIGNED)) / listed_price * 100) BETWEEN 30 AND 45')->get();
            @endphp
                    ...
                    <div class="product-box">
                        ...
                        <div class="product-style-3 product-style-chair">
                            <div class="product-title d-block mb-0">
                                ...
                                <form id="addWishlist-{{$productSale->id}}" class="wishlist" action="{{route('shop.wishlist.addWishlist')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="product_id" id="product_id" value="{{$productSale->id}}">
                                </form>
                                <div id="wishlistMessage-{{ $productSale->id }}" style="display: none;"></div>
                            </div>
                        </div>
                    </div>
                </div>
