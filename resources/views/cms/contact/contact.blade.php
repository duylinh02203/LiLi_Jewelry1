                    ...
                    <form action="{{route('admin.contact.create')}}" method="POST">
                        ...
                        <div class="row g-4 mt-md-1 mt-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="email" class="form-control" id="email" placeholder="Nhập địa chỉ Email của bạn" value="{{old('email')}}">
                            </div>
                            <div class="col-md-6">
                                <label for="email2" class="form-label">Điện thoại
                                    @error('phone')
                                ...
                                <input type="text" name="phone" class="form-control" id="email2" placeholder="Nhập số điện thoại của bạn" value="{{old('phone')}}">
                            </div>
