    ...
    <div id="sizeOverlay" class="size-overlay" style="display:none;">
        <div class="size-modal">
            ...
            <div class="d-flex justify-content-between">
                <button id="cancelSize" type="button" class="btn btn-outline-dark"
                    style="border-radius:10px;">Hủy</button>
                <button id="confirmSize" type="button" class="btn"
                    style="background-color: #e87316; color: black; font-weight: bold; border-radius:10px;">Xác
                    nhận</button>
            </div>
        </div>
    </div>
