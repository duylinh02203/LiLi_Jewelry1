...
<section class="section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <ul class="nav nav-tabs custome-nav-tabs flex-column category-option" id="myTab" style="padding-left: 15px;">
                                ...
                                <div class="order-box-contain my-4">
                                    <div class="row g-4">
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="order-box">
                                                <div class="order-box-image">
                                                    <img src="{{asset('cms/assets/images/svg/box.png')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                </div>
                                                <div class="order-box-contain">
                                                    <img src="{{asset('cms/assets/images/svg/box1.png')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                    <div>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="order-box">
                                                <div class="order-box-image">
                                                    <img src="{{asset('cms/assets/images/svg/sent.png')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                </div>
                                                <div class="order-box-contain">
                                                    <img src="{{asset('cms/assets/images/svg/sent1.png')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                    <div>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="order-box">
                                                <div class="order-box-image">
                                                    <img src="{{asset('cms/assets/images/svg/wishlist.png')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                </div>
                                                <div class="order-box-contain">
                                                    <img src="{{asset('cms/assets/images/svg/wishlist1.png')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                    <div>
                            ...
                            <table class="table cart-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="details.php">
                                                <img src="{{asset('cms/assets/images/fashion/product/front/1.jpg')}}" class="blur-up lazyload" alt="">
                                            </a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="details.php">
                                                <img src="{{asset('cms/assets/images/fashion/product/front/2.jpg')}}" class="blur-up lazyload" alt="">
                                            </a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="details.php">
                                                <img src="{{asset('cms/assets/images/fashion/product/front/3.jpg')}}" class="blur-up lazyload" alt="">
                                            </a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="details.php">
                                                <img src="{{asset('cms/assets/images/fashion/product/front/4.jpg')}}" class="blur-up lazyload" alt="">
                                            </a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="details.php">
                                                <img src="{{asset('cms/assets/images/fashion/product/front/5.jpg')}}" class="blur-up lazyload" alt="">
                                            </a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="details.php">
                                                <img src="{{asset('cms/assets/images/fashion/product/front/6.jpg')}}" class="blur-up lazyload" alt="">
                                            </a>
                                        </td>
                                        <td>
                                    ...
                                    <div class="payment-card-detail">
                                        <div class="card-details">
                                            ...
                                            <div class="name-detail">
                                                ...
                                                <div class="card-img">
                                                    <img src="{{asset('cms/assets/images/payment-icon/1.jpg')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="payment-card-detail">
                                        <div class="card-details card-visa">
                                            ...
                                            <div class="name-detail">
                                                ...
                                                <div class="card-img">
                                                    <img src="{{asset('cms/assets/images/payment-icon/2.jpg')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="payment-card-detail">
                                        <div class="card-details dabit-card">
                                            ...
                                            <div class="name-detail">
                                                ...
                                                <div class="card-img">
                                                    <img src="{{asset('cms/assets/images/payment-icon/3.jpg')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                </div>
                                            </div>
                                        </div>
