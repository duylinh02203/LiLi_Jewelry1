        ...
        <div class="row justify-content-center text-center">
            ...
            <div class="col-12 col-md-8 col-lg-6 p-4">
                ...
                <div class="d-flex justify-content-between" style="font-size: 14px;">
                    ...
                    <span>Số phiếu: DL00{{ $orderWithItems->id }}</span>
                </div>
                ...
                <table class="table table-bordered table-sm mt-3" style="font-size: 14px;">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td class="fw-bold">{{ number_format($orderWithItems->total_price) }} VND</td>
                        </tr>
                    </tbody>
                </table>

                <p class="fw-bold">Xin cảm ơn Quý khách!  Thank you!</p>
