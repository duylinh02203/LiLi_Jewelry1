...
@section('content')
    ...
    <section class="section-b-space">
        @if (session('userData'))
            <form action="{{ route('payment.orders') }}" method="POST" name="redirect">
                @csrf
                <div class="container">
                    <div class="row g-4">
                        <div class="col-lg-8">
                            <div id="billingAddress" class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="phone"
                                        placeholder="Nhập số điện thoại" value="{{ $userInfor->phone ?? '' }}">
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if ($userInfor->address || $userInfor->province || $userInfor->district)
                                        <textarea class="form-control" id="address" name="address">{{ $userInfor->address . ' ' . $userInfor->district . ' ' . $userInfor->province }}</textarea>
                                    @else
                            ...
                            <button class="btn btn-solid-default mt-4 thanh-toan" name="redirect">Thanh toán</button>
                        </div>
