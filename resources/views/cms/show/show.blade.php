                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                    ...
                                    @if($product->price < $product->listed_price)
                                        <del>{{ number_format($product->listed_price, 0, ',', '.') }}
                                            đ</del><span>{{ round((($product->listed_price - $product->price) / $product->listed_price) * 100) }}
                                            % off</span>
                                        @endif
                                        @else
                                        {{ number_format($product->listed_price) }} đ
                                        @endif
                                </h3>
                                <div class="label-section">
                                    <p class="product-quantity">
                                        <strong>Số lượng trong kho: </strong>
                                        <span id="product-quantity-display">{{$product->quantity}}</span>
                                    </p>
                                </div>

                                <div class="label-section">
                                    <p class="product-description"><strong>Mô tả: </strong>{!! nl2br(e($product->description)) !!}</p>
                                </div>
                                <div>
                                    <p><strong>Lưu ý:
                                        </strong>{{ $product->is_free_size === 1 ? 'Sản phẩm Free Size có thể điều chỉnh kích thước tùy ý. Nếu bạn yêu cầu khắc tên, vui lòng ấn liên hệ để được hỗ trợ' : 'Nếu bạn yêu cầu khắc tên, thắc mắc về size số vui lòng ấn liên hệ (góc phải) để được hỗ trợ !' }}
                                    </p>
                                </div>
                                <div class="size-selector">
                                                                    <strong style="margin-bottom: 10px;"><span>Kích thước & Số lượng:</span></strong>
                        ...
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                ...
                                <div class="wrap-retail">
                                    ...
                                    <h3 class="theme-color">{{ number_format($product->price) }}
                                        đ</h3>
                ...
                .then(data => {
                    ...
                    if (data.status === 'success') {
                        ...
                        if (typeof data.remaining_quantity !== 'undefined') {
                            ...
                            if (quantityDisplay) {
                                quantityDisplay.textContent = data.remaining_quantity;
                            }
                        }
                    }
                })
